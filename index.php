...
<body>
    ...
    <header>
        ...
        <h5 style="color:#DDC9A3; margin-top: 15px;">Inicio - Productividad Residentes Medicina Interna</h5>
        <br>
    </header>
    <br>
    ...
    <div class="col-7">
        <div class="container">
            <iframe src="productividad.php" frameborder="0" width="100%" height="800px" style="margin-bottom: 100px;"></iframe>
